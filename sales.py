...
class salesClass:
    def __init__(self, root):
        ...
        txt_invoice=Entry(self.root,text=self.var_invoice,font=("times new roman",15),bg="lightblue",fg="black")
        ...
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("times new roman",15,"bold"),bg="#3e3d53",fg="white",cursor="hand2").place(x=490,y=100,width=120,height=28)
        ...
        bill_Frame.place(x=280,y=140,width=413,height=330)
    ...
    def search(self):
        if self.var_invoice.get()=="":
            ...
            if self.var_invoice.get() in self.bill_list:
                ...
                messagebox.showerror("Error","Invoice No. is not valid",parent=self.root)
