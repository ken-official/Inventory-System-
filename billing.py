...
class BillClass:
    def __init__(self, root):
        ...
        title=Label(self.root,text="Inventory Management System",image=self.icon_title,compound=LEFT,font=("times new roman",40,"bold"),bg="#A82626",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
        ...
        txt_search=Entry(ProductFrame2,textvariable=self.var_search,font=("times new roman",15),bg="lightblue").place(x=130,y=47,width=150,height=22)
        ...
        btn_show_all=Button(ProductFrame2,text="All Product",command=self.show,font=("goudy old style",15),bg="#083531",fg="white",cursor="hand2").place(x=280,y=10,width=100,height=25)
        ...
        txt_name=Entry(CustomerFrame,textvariable=self.var_cname,font=("times new roman",13),bg="lightblue").place(x=80,y=35,width=180)

        lbl_contact=Label(CustomerFrame,text="Contact",font=("times new roman",15),bg="white").place(x=270,y=35)
        txt_contact=Entry(CustomerFrame,textvariable=self.var_contact,font=("times new roman",13),bg="lightblue").place(x=380,y=35,width=140)
        ...
        btn_dif=Button(Cal_Frame,text="-",font=("arial",15,"bold"),command=lambda:self.get_input('-'),bd=5,width=4,pady=10,cursor="hand2").grid(row=2,column=3)
        ...
        btn_prod=Button(Cal_Frame,text="*",font=("arial",15,"bold"),command=lambda:self.get_input('*'),bd=5,width=4,pady=10,cursor="hand2").grid(row=3,column=3)
        ...
        self.cartTitle=Label(cart_Frame,text="Cart \t Total Product: ",font=("goudy old style",15,),bg="lightgray")
        ...
        txt_p_name=Entry(Add_CartWidgetsFrame,textvariable=self.var_pname,font=("times new roman",15),bg="lightblue",state='readonly').place(x=5,y=35,width=190,height=22)

        lbl_p_price=Label(Add_CartWidgetsFrame,text="Price per Qty",font=("times new roman",15),bg="white").place(x=230,y=5)
        txt_p_price=Entry(Add_CartWidgetsFrame,textvariable=self.var_price,font=("times new roman",15),bg="lightblue",state='readonly').place(x=230,y=35,width=150,height=22)

        lbl_p_quantity=Label(Add_CartWidgetsFrame,text="Quantity",font=("times new roman",15),bg="white").place(x=390,y=5)
        txt_p_quantity=Entry(Add_CartWidgetsFrame,textvariable=self.var_qty,font=("times new roman",15),bg="lightblue").place(x=390,y=35,width=120,height=22)

        self.lbl_inStock=Label(Add_CartWidgetsFrame,text="Stock",font=("times new roman",15),bg="white")
    ...
    #===Billing Area===#
        ...
        bTitle=Label(billFrame,text="Customer Biling Area",font=("times new roman",20,"bold"),bg="orange",fg="white").pack(side=TOP,fill=X)
    ...
    #===Billing Buttons===#
        ...
        self.lbl_amount=Button(billMenuFrame,text="Bill Amount\n[0]",font=("goudy old style",15,"bold"),bg="#3f51b5",fg="white",cursor="hand2")
        self.lbl_amount.place(x=2,y=5,width=400,height=70)
...
#==============================================================================================================
# SHOW THE DETAILS BELLOW AND ON THE FIELD
#==============================================================================================================
...
#==============================================================================================================
# SEARCHING INPUT ON THE PRODUCT CLASS
#==============================================================================================================
    ...
    def add_update_cart(self):
        if self.var_pid.get()=="":
            ...
            for row in self.cart_list:
                ...
                index_+=1
            if present=='yes':
                op=messagebox.askyesno('Confirm','Product alreayd present\nDo you want to Update | Remove from the Cart List',parent=self.root)
                if op==True:
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tAgila-Inventory
\tPhone No. 98725***** , Tuguegarao City
{str("="*47)}
...
{str("="*47)}
    ...
    def bill_bottom(self):
        bill_bottom_temp=f'''
{str("="*47)}
 Bill Amount: \t\t\tPhp{self.bill_amnt}
{str("="*47)}\n
        '''
    ...
    def bill_middle(self):
        ...
        try:
            for row in self.cart_list:
                ...
                price=str(price)
                self.txt_bill_area.insert(END,"\n "+name+"\t\t\t"+row[3]+"\tPhp"+price)
                #===Update Quantity in Product Tble===#
