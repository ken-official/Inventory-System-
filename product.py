...
class productClass:
    def __init__(self, root):
        ...
        #===Column 1===#
        lbl_category=Label(product_Frame,text="Category",font=("goudy old style",13),bg="white").place(x=30,y=60)
        lbl_supplier=Label(product_Frame,text="Supplier",font=("goudy old style",13),bg="white").place(x=30,y=110)
        lbl_product_name=Label(product_Frame,text="Name",font=("goudy old style",13),bg="white").place(x=30,y=160)
        lbl_price=Label(product_Frame,text="Price",font=("goudy old style",13),bg="white").place(x=30,y=210)
        lbl_quantity=Label(product_Frame,text="Quantity",font=("goudy old style",13),bg="white").place(x=30,y=260)
        lbl_status=Label(product_Frame,text="Status",font=("goudy old style",13),bg="white").place(x=30,y=310)
        ...
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15),bg="lightblue").place(x=162,y=175,width=200)
        txt_price=Entry(self.root,textvariable=self.var_price,font=("goudy old style",15),bg="lightblue").place(x=162,y=225,width=200)
        txt_quantity=Entry(self.root,textvariable=self.var_qty,font=("goudy old style",15),bg="lightblue").place(x=162,y=275,width=200)
...
#==============================================================================================================
    ...
    def update(self):
        ...
        try:
            if self.var_pid.get()=="":
                messagebox.showerror("Error","Please select product form the list",parent=self.root)
            else:
                cur.execute("Select * from product where pid=?",(self.var_pid.get(),))
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error","Product Inavalid",parent=self.root)
                else:
    ...
    def delete(self):
        ...
        try:
            if self.var_pid.get()=="":
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error","There is no Selected Product",parent=self.root)
                else:
